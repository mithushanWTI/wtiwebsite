    ...
    <section className="py-12 px-4 md:px-25">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        ...
        {limitedPackages.map((pkg) => (
         <div 
         key={pkg.id} 
         className="shadow-lg rounded-lg overflow-hidden transition hover:shadow-xl w-full sm:w-1/2 lg:w-1/4" // Add responsive classes back
         style={{ 
           width: window.innerWidth >= 1024 ? 'calc(25% - 1.5rem)' : window.innerWidth >= 768 ? 'calc(50% - 1.5rem)' : '100%' // Apply fixed width only on larger screens
         }} 
       >
